...
### Known Issues
- Child tokens created via manual renewal or auto-renewal do not include `token_type` and `parent_jti` claims
...
- Parent/child token claims incomplete (see Known Issues)
...
- [JWT-PARENT-CHILD-TECHNICAL-GAPS.md](../JWT-PARENT-CHILD-TECHNICAL-GAPS.md) for architectural gaps

[Unreleased]: https://github.com/klazomenai/jwt-auth-service/compare/v0.0.1-alpha...HEAD
[0.0.1-alpha]: https://github.com/klazomenai/jwt-auth-service/releases/tag/v0.0.1-alpha
